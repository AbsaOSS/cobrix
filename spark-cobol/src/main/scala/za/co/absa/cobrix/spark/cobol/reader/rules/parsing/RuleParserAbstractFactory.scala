...
import za.co.absa.cobrix.spark.cobol.reader.rules.parsing.impl.{JaninoRulesParser, NashornRuleParser}

/**
  * Factory for rules parsers.
  *
...
private[rules] object RuleParserAbstractFactory {
  ...
  def buildNashornParser(): RulesParserTemplate = new NashornRuleParser()
}