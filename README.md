...
<tr>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.11<br>version: 2.10.6</pre>
</td>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.12<br>version: 2.10.6</pre>
</td>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.13<br>version: 2.10.6</pre>
</td>
</tr>
</table>
...
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.11:2.10.6
```

### Spark compiled with Scala 2.12
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.12:2.10.6
```

### Spark compiled with Scala 2.13
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.13:2.10.6
```
...
* spark-cobol_2.12-2.10.6.jar
* cobol-parser_2.12-2.10.6.jar
...
```
$ spark-shell --packages za.co.absa.cobrix:spark-cobol_2.12:2.10.6
or 
$ spark-shell --master yarn --deploy-mode client --driver-cores 4 --driver-memory 4G --jars spark-cobol_2.12-2.10.6.jar,cobol-parser_2.12-2.10.6.jar
...
```sh
$ spark-shell --jars spark-cobol_2.12_3.3-2.10.7-SNAPSHOT-bundle.jar
```
...
## Changelog
- #### 2.10.6 released 22 June 2026.
    - [#853](https://github.com/AbsaOSS/cobrix/pull/853) Fixed decoding of COMP-1 fields that use IBM floating-point format.
    - [#855](https://github.com/AbsaOSS/cobrix/pull/855) Added COMP-1 and COMP-2 floating point encoders for the writer.

- #### 2.10.5 released 8 June 2026.
   - [#850](https://github.com/AbsaOSS/cobrix/pull/850) Added the ability to define rules when redefined fields are valid.
     ```scala
     .option("redefine_rule:1", "COMPANY => RECORD_TYPE = 'C'")
     .option("redefine_rule:2", "PERSON => in(RECORD_TYPE, 'P', 'E')")
     ```
     For more, see [Automatic filtering of arbitrary redefines](#automatic-filtering-of-arbitrary-redefines).
...
- #### 2.10.1 released 27 March 2026.
   - [#836](https://github.com/AbsaOSS/cobrix/pull/836) Add options to remove headers and footers when loading files that have them. Thanks @alexzvk!
     ```scala
