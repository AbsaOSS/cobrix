...
<tr>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.11<br>version: 2.10.2</pre>
</td>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.12<br>version: 2.10.2</pre>
</td>
<td>
<pre>groupId: za.co.absa.cobrix<br>artifactId: spark-cobol_2.13<br>version: 2.10.2</pre>
</td>
</tr>
</table>
...
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.11:2.10.2
```

### Spark compiled with Scala 2.12
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.12:2.10.2
```

### Spark compiled with Scala 2.13
```
$SPARK_HOME/bin/spark-shell --packages za.co.absa.cobrix:spark-cobol_2.13:2.10.2
```
...
* spark-cobol_2.12-2.10.2.jar
* cobol-parser_2.12-2.10.2.jar
...
```
$ spark-shell --packages za.co.absa.cobrix:spark-cobol_2.12:2.10.2
or 
$ spark-shell --master yarn --deploy-mode client --driver-cores 4 --driver-memory 4G --jars spark-cobol_2.12-2.10.2.jar,cobol-parser_2.12-2.10.2.jar
...
```sh
$ spark-shell --jars spark-cobol_2.12_3.3-2.10.3-SNAPSHOT-bundle.jar
```
