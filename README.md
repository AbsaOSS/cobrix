...
| .option("strict_sign_overpunching", "false") | If `true`, sign overpunching will only be allowed for signed numbers. If `false` (default), overpunched positive sign will be allowed for unsigned numbers.                                                                                                                     |
