...
class CopybookSuite extends AnyWordSpec {
  ...
  "isPartOfSegment" should {
    "work for segment 1" in {
      assert(copybook.isPartOfSegment(copybook.getFieldByName("SEG1"), "1"))
      ...
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG2"), "1"))
      ...
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG3"), "1"))
    ...
    "work for segment 2" in {
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG1"), "2"))
      ...
      assert(copybook.isPartOfSegment(copybook.getFieldByName("SEG2"), "2"))
      ...
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG3"), "2"))
    ...
    "work for segment 3" in {
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG1"), "3"))
      ...
      assert(!copybook.isPartOfSegment(copybook.getFieldByName("SEG2"), "3"))
      ...
      assert(copybook.isPartOfSegment(copybook.getFieldByName("SEG3"), "3"))
