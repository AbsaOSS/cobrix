...
identifier:
    ...
    | BINARY | DISPLAY | PACKED_DECIMAL
    | COMPUTATIONAL | COMPUTATIONAL_0 | COMPUTATIONAL_1 | COMPUTATIONAL_2 | COMPUTATIONAL_3 | COMPUTATIONAL_3U | COMPUTATIONAL_4 | COMPUTATIONAL_5 | COMPUTATIONAL_9
    | COMP | COMP_0 | COMP_1 | COMP_2 | COMP_3 | COMP_3U | COMP_4 | COMP_5 | COMP_9
    | REDEFINES | RENAMES
    | VALUE | VALUES
    | OCCURS | TIMES | DEPENDING | INDEXED
    | BLANK | ZERO | ZEROS | ZEROES | SPACE | SPACES
    | HIGH_VALUE | HIGH_VALUES | LOW_VALUE | LOW_VALUES
    | NULL | NULLS | QUOTE | QUOTES
    | JUSTIFIED | JUST | RIGHT
    | PICTURE | PIC
    | TRUE | FALSE
    | ARE | IS | ON | BY | WHEN | TO | ALL
    | USAGE | FROM
    ;
...
usageLiteral:
    (
      COMPUTATIONAL_0 | COMPUTATIONAL_1 | COMPUTATIONAL_2 | COMPUTATIONAL_3 | COMPUTATIONAL_3U | COMPUTATIONAL_4 | COMPUTATIONAL_5 | COMPUTATIONAL_9 | COMPUTATIONAL
    | COMP_0 | COMP_1 | COMP_2 | COMP_3 | COMP_3U | COMP_4 | COMP_5 | COMP_9 | COMP
    | DISPLAY
    | BINARY
    | PACKED_DECIMAL
    )
...
groupUsageLiteral:
    (
      COMPUTATIONAL_0 | COMPUTATIONAL_3 | COMPUTATIONAL_3U | COMPUTATIONAL_4 | COMPUTATIONAL_5 | COMPUTATIONAL_9 | COMPUTATIONAL
    | COMP_0 | COMP_3 | COMP_3U | COMP_4 | COMP_5 | COMP_9 | COMP
    | DISPLAY
    | BINARY
    | PACKED_DECIMAL
    )
