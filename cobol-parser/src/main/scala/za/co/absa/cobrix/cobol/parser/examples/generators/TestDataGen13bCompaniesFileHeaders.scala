...
/**
  ...
  *
  * The output file will contain a file headerof 100 bytes and footer of 120 bytes.
  */
object TestDataGen13bCompaniesFileHeaders {

  val numberOfRecordsToGenerate = 20
  ...
  def main(args: Array[String]): Unit = {
    ...
    val headerArray = Array.fill(100) {1.toByte}
    val footerArray = Array.fill(120) {2.toByte}

    val bos = new BufferedOutputStream(new FileOutputStream("COMP.DETAILS.JUN02.DATA.RDW.BE.dat"))
