...
public class jsonParser extends Parser {
	...
	public static class Value_trueContext extends ValueContext {
		public Value_trueContext(ValueContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_true(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_falseContext extends ValueContext {
		public Value_falseContext(ValueContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_false(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_stringContext extends ValueContext {
		public TerminalNode STRING() { return getToken(jsonParser.STRING, 0); }
		public Value_stringContext(ValueContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_string(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_objContext extends ValueContext {
		public ObjContext obj() {
			return getRuleContext(ObjContext.class,0);
		}
		public Value_objContext(ValueContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_obj(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_numberContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_number(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_nullContext extends ValueContext {
		public Value_nullContext(ValueContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_null(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Value_arrayContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof jsonVisitor ) return ((jsonVisitor<? extends T>)visitor).visitValue_array(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			switch (_input.LA(1)) {
			case STRING:
				_localctx = new Value_stringContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(46);
				match(STRING);
			...
			case NUMBER:
				...
				break;
			case T__0:
				_localctx = new Value_objContext(_localctx);
			...
			case T__4:
				...
				break;
			case T__6:
				_localctx = new Value_trueContext(_localctx);
				...
				break;
			case T__7:
				_localctx = new Value_falseContext(_localctx);
				...
				break;
			case T__8:
				_localctx = new Value_nullContext(_localctx);
