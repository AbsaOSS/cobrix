...
object TestDataGen13aFileHeaderAndFooter {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val bos = new BufferedOutputStream(new FileOutputStream("TRAN2.JUN24.DATA.dat"))
    var i = 0
    val sig = "S9276511"

    val headerArray = Array.fill(10) {1.toByte}
    val footerArray = Array.fill(12) {2.toByte}
