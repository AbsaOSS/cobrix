...
object SparkCobolApp {
  ...
  /**
    ...
    * </pre>
    * The option says that root (level 0) segment has SEGMEIT_ID="S01L1". For each record of the file
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark
      ...
      //.option("copybook", "data/companies_copybook.cpy") // Or as a path name in HDFS. For local sylesystem use file:// prefix
      ...
      .option("segment_id_level0", "S01L1")                // Root segment is equals "S01L1". All other segments are it's childern
